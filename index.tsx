...
const App = () => {
  ...
  const onAnalyze = async () => {
    ...
    try {
      // Use process.env.API_KEY directly as mandated
      ...
      const response = await ai.models.generateContent({
        ...
        contents: {
          parts: [
            ...
            { text: `אבחן את הצילום "${photoName || 'ללא שם'}" לפי מתודולוגיית פוטואקטיב. ניתוח מערכתי חודר של 5 השכבות: טכנית, רגשית, תקשורתית, אור וזהות. החזר JSON בעברית.` }
          ]
        },
        config: {
